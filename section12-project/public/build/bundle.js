...
var app = (function () {
    ...
    /* src\Spring.svelte generated by Svelte v3.42.3 */
    ...
    // (77:4) {#each $cards as card, i (card.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$1, 77, 6, 1312);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(77:4) {#each $cards as card, i (card.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 75, 2, 1246);
    			attr_dev(div1, "class", "page svelte-1a1ekzd");
    			add_location(div1, file$1, 74, 0, 1225);
    		},
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 46, 4, 962);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*boxes*/ 2) && t_value !== (t_value = /*box*/ ctx[5] + "")) set_data_dev(t, t_value);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 42, 0, 850);
    			add_location(button, file, 43, 0, 891);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
